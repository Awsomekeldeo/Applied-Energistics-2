...
public class OptionalSlotFakeFluid extends SlotFakeFluid implements IOptionalSlot
{
	...
	public OptionalSlotFakeFluid( final AEFluidInventory inv, final IOptionalSlotHost containerBus, final int idx, final int x, final int y, final int offX, final int offY, final int groupNum )
	{
